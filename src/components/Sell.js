...
export default function Sell() {
    ...
    const { loadByUser, createNew } = bindActionCreators(pAC, dispatch)
        ...
        <div className="container my-3">
            <form onSubmit={onSubmit} >
                ...
                <div className="mb-3">
                    ...
                    <input type="file" accept="image/jpeg, image/png" value={myImage} onChange={(e) => { onChange(e) }} className="form-control" id="image" name="image" />
                </div>
